...
public class TextureDebugUI : MonoBehaviour
{
    ...
    [Header("View")]
    public DebugMode mode = DebugMode.RGB;
    [Range(0f, 10f)]
    ...
    private void BuildUI()
    {
        ...
        if (debugShader == null)
            debugShader = Shader.Find("Debug/UI_TextureDebugView");

        if (debugShader == null)
        {
            Debug.LogError("[TextureDebugUI] 找不到 Shader: Debug/UI_TextureDebugView");
            return;
        }

        runtimeMaterial = new Material(debugShader);
        runtimeMaterial.name = "M_Runtime_TextureDebugUI";

        GameObject canvasGo = new GameObject("TextureDebugUI_Canvas");
        ...
        GameObject rawGo = new GameObject("TextureView");
        ...
        titleText = CreateText(panelGo.transform, "Title", "Texture Debug", 14, TextAnchor.MiddleLeft);
        ...
        Button closeBtn = CreateButton(panelGo.transform, "CloseButton", "×");
        ...
        Button plusBtn = CreateButton(panelGo.transform, "PlusButton", "+");
        ...
        Button minusBtn = CreateButton(panelGo.transform, "MinusButton", "-");
        ...
        Button modeBtn = CreateButton(panelGo.transform, "ModeButton", "Mode");
        ...
        scaleText = CreateText(panelGo.transform, "ScaleText", "100%", 12, TextAnchor.MiddleRight);
        ...
        Button miniBtn = CreateButton(canvasGo.transform, "MiniToggleButton", "RT");
